...
flags.DEFINE_string('tflite_path', 'efficientnet-lite0/efficientnet-lite0-int8.tflite', 'tflite files')
...
def main(unused_argv):
  ...
  elif FLAGS.runmode == 'imagenet_lite':

    driver.eval_imagenet_lite(FLAGS.tflite_path, FLAGS.imagenet_eval_glob,
                         FLAGS.imagenet_eval_label, FLAGS.num_images,
                         FLAGS.enable_ema, FLAGS.export_ckpt)
